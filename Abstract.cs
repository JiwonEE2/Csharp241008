...
namespace Csharp241008
{
	internal class Abstract
	{
		...
		- 인스턴스화할 수 없는 클래스이며 abstract 키워드를 사용하여 추상 클래스 정의
		...
		- 가상 함수는 기본 구현을 포함. 자식 클래스에서의 필요에 따라 오버라이딩 가능
		- 오버라이딩하지 않으면 부모 클래스의 기본 구현을 그대로 사용
		*/
		...
		{
			//Item item = new Item();	// 추상 클래스는 인스턴스 생성 불가
